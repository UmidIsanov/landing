...
import CustomModalPageTutor from "../../ModalPage/ui/CustomModalPageTutor";
...
const CustomTableTutor: FC<TTableProps> = ({ data }) => {
  ...
  return (
    <>
      ...
      <CustomModalPageTutor open={openModal} handleClose={handleCloseModal} rowData={rowData} />
    </>
  );
};

export default CustomTableTutor;
